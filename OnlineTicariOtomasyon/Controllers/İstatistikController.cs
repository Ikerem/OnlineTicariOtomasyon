...
namespace OnlineTicariOtomasyon.Controllers
{
    public class İstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d9 = deger9;
            var deger10 = c.Uruns.Count(x => x.UrunAd == "Çamaşır Makinası").ToString();
            ViewBag.d10 = deger10;
        ...
        public PartialViewResult Partila2()
        {
            var sargu=c.Carilers.ToList();
            return PartialView(sargu);
        }
        public PartialViewResult Partila3()
        {
